...
\begin{equation}\label{eq:imaginary_factorization}
\sqrt{-a} = \sqrt{-1} \times \sqrt{a}
\end{equation}

\begin{equation}\label{eq:imaginary_number}
\sqrt{-a} = i \sqrt{a}
\end{equation}
...
\end{figure}
 ...
 \begin{equation}\label{eq:complex_magnitude}
 |z| = \sqrt{x^2 + y^2}
 \end{equation}
...
\begin{equation}\label{eq:vector_definition}
...
\begin{equation}\label{eq:general_vector}
...
\begin{equation}\label{eq:matrix_indices}
...
\begin{equation}\label{eq:matrix_vector_product}
\ket{a'} = M\ket{a}
\end{equation}
...
\begin{equation}\label{eq:identity_definition}
M^{-1}M = MM^{-1} = I
\end{equation}
...
\begin{equation}\label{eq:identity_property}
I\ket{v} = \ket{v}
\end{equation}
...
\begin{equation}\label{eq:unitary_definition}
U^\dagger = U^{-1}
\end{equation}

This means 

\begin{equation}\label{eq:unitary_property}
U^\dagger U = U^{-1}U = I
\end{equation}
...
\begin{equation}\label{eq:coin_superposition}
...
\begin{equation}\label{eq:ket_heads}
 \ket{H} = 
\begin{bmatrix}
0 \\ 1
\end{bmatrix} 
...
\begin{equation}\label{eq:ket_tails}
\ket{T} = 
\begin{bmatrix}
1 \\ 0
\end{bmatrix} 
...
\begin{equation}\label{eq:plus_state}
...
\begin{equation}\label{eq:biased_state}
...
\begin{equation}\label{eq:bra_definition}
\bra{\psi} = (\ket{\psi}^*)^T
\end{equation}
...
\begin{equation}\label{eq:general_bra}
...
\begin{equation}\label{eq:operator_action}
...
\begin{equation}\label{eq:z_operator}
...
\begin{equation}\label{eq:flip_operator}
...
\begin{equation}\label{eq:quantum_expectation}
...
\begin{equation}\label{eq:computational_basis}
...
\begin{equation}\label{eq:prob_zero}
P(\ket{0}) = |\braket{0|\psi}|^2 = (\cos{\theta/2})^2
\end{equation}
Similarly for the probability of $\ket{1}$

\begin{equation}\label{eq:prob_one}
P(\ket{1}) = |\braket{0|\psi}|^2 = (\sin{\theta/2})^2
\end{equation}

Up and down, the z-axis is where the $\ket{0}$ \& $\ket{1}$ are, for that reason the z-axis is known as the computational basis. In addition we have the x \& y axis which correspond to different states. A useful tool for understanding the Bloch sphere [can be found here](https://javafxpert.github.io/grok-bloch/)
...
\begin{equation}\label{eq:hadamard_zero}
...
\begin{equation}\label{eq:hadamard_one}
...
\begin{equation}\label{eq:general_qubit}
...
\begin{equation}\label{eq:bloch_parameterization}
...
\begin{equation}\label{eq:ry_gate}
...
\begin{equation}\label{eq:rz_gate}
...
\begin{equation}\label{eq:general_unitary}
...
\begin{equation}\label{eq:qubit_ordering}
...
\begin{equation}\label{eq:tensor_product_result}
...
\begin{equation}\label{eq:cnot_01}
...
\begin{equation}\label{eq:cnot_10}
...
\begin{equation}\label{eq:bell_phi_plus}
\ket{\Phi^+} = \frac{1}{2} \left( \ket{00} + \ket{11} \right)
\end{equation}
\begin{equation}\label{eq:bell_phi_minus}
\ket{\Phi^-} = \frac{1}{2} \left( \ket{00} - \ket{11} \right)
\end{equation}
\begin{equation}\label{eq:bell_psi_plus}
\ket{\Psi^+} = \frac{1}{2} \left( \ket{01} + \ket{10} \right)
\end{equation}
\begin{equation}\label{eq:bell_psi_minus}
...
\begin{equation}\label{eq:qft_action}
\hat{F}\ket{j}= \ket{\tilde{j}}
\end{equation}
\begin{equation}\label{eq:qft_operator}
...
\begin{equation}\label{eq:phase_error}
\Delta = | \phi - 2\pi jk/N |
\end{equation}
...
\begin{equation}\label{eq:max_phase_error}
...
\begin{equation}\label{eq:phase_precision_limit}
