...
At this point, guessing either of the coins would have a 50\% chance of getting the right outcome- the same as for one coin from a pair of simultaneously tossed coins.  
...
\begin{enumerate}
    ...
    \item Imagine the vector $\ket{v}$ given by 
...
\subsection{ A trip to the casino} \label{casino}
...
\subsection{Aside: gates vs operators, computation and physics}
